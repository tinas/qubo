...
describe('DateAfterOperator', () => {
  let operator: DateAfterOperator;
  ...
  it('should handle time components', () => {
    ...
    expect(operator.evaluate(date, '2024-01-25T11:59:59Z')).toBe(true);
    expect(operator.evaluate(date, '2024-01-25T12:00:00Z')).toBe(false);
    expect(operator.evaluate(date, '2024-01-25T12:00:01Z')).toBe(false);
  });
